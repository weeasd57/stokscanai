        ...
        <header className="sticky top-0 z-50 w-full border-b border-white/5 bg-black/60 backdrop-blur-xl supports-[backdrop-filter]:bg-black/30">
            <div className="max-w-[1920px] mx-auto">
                <div className="flex flex-col md:flex-row md:items-center justify-start px-4 md:px-8 py-4 gap-4 md:gap-0">
                    ...
                    <nav className="relative w-full md:w-auto overflow-x-auto pb-2 md:pb-0 -mx-4 px-4 md:mx-0 md:px-0 scrollbar-hide">
                        <div className="flex items-center gap-1.5 md:gap-2 min-w-max p-1.5 bg-zinc-900/50 border border-white/5 rounded-2xl backdrop-blur-sm">
                            {tabs.map((tab) => {
                                ...
                                return (
                                    <button
                                        ...
                                        className={`
                                            relative px-4 md:px-6 py-2.5 rounded-xl text-[10px] md:text-xs font-black tracking-wider transition-all duration-300 flex items-center justify-center
                                            ${isActive
